...
public class e_tech_class extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					e_tech_class frame = new e_tech_class();
	...
	public e_tech_class() {
		...
		btnback.setIcon(new ImageIcon(e_tech_class.class.getResource("/Images/back.png")));
		...
		btnsave.setIcon(new ImageIcon(e_tech_class.class.getResource("/Images/save.png")));
...
*/
		...
		btnupdate.setIcon(new ImageIcon(e_tech_class.class.getResource("/Images/update.png")));
		...
		contentPane.add(button);
				...
				label_1.setIcon(new ImageIcon(e_tech_class.class.getResource("/Images/bg.png")));
		...
		try {
			...
			String query2 = "select name from subject where subjectID='SB71'";
			...
			String query3 = "select name from subject where subjectID='SB72'";
			...
			String query4 = "select name from subject where subjectID='SB63'";
