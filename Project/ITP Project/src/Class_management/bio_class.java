...
public class bio_class extends JFrame {
	...
	public bio_class() {
		...
		btnback.setIcon(new ImageIcon(bio_class.class.getResource("/Images/back.png")));
		...
		btnsave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String classQuery = "select classID from class where name='"+tempClass1.getName()+"'";
					...
					//add 2nd raw
					 ...
					 String  classQuery2 = "select classID from class where name='"+tempClass1.getName()+"'";
					...
					//end 2nd row
					 ...
					 classQuery = "select classID from class where name='"+tempClass1.getName()+"'";
		...
		btnsave.setIcon(new ImageIcon(bio_class.class.getResource("/Images/save.png")));
...
*/
		...
		btnupdate.setIcon(new ImageIcon(bio_class.class.getResource("/Images/update.png")));
		...
		contentPane.add(button);
				...
				label_1.setIcon(new ImageIcon(bio_class.class.getResource("/Images/bg.png")));
		...
		try {
			...
			String query2 = "select name from subject where subjectID='SB25'";
