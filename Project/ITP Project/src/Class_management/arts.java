...
public class arts extends JFrame {
	...
	public arts() {
		...
		btnback.setIcon(new ImageIcon(arts.class.getResource("/Images/back.png")));
		...
		btnsave.setIcon(new ImageIcon(arts.class.getResource("/Images/save.png")));
...
*/
		...
		btnupdate.setIcon(new ImageIcon(arts.class.getResource("/Images/update.png")));
		...
		contentPane.add(button);
				...
				label_1.setIcon(new ImageIcon(arts.class.getResource("/Images/bg.png")));
		...
		try {
			...
			String query2 = "select name from subject where subjectID='SB51'";
			...
			String query3 = "select name from subject where subjectID='SB10'";
			...
			String query4 = "select name from subject where subjectID='SB53'";
