...
public class alclasses extends JFrame {

	private JPanel contentPane;
	private final JScrollPane scrollPane = new JScrollPane();
	private final JTable table = new JTable();
	JFormattedTextField sbid1,sbid2;
	...
	public alclasses() {
		...
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "ClassID", "StaffID", "SubjectID" }));
		...
		sbid2 = new JFormattedTextField();
		sbid2.setFont(new Font("Tahoma", Font.PLAIN, 14));
		sbid2.setEditable(false);
		sbid2.setBounds(154, 240, 125, 25);
		contentPane.add(sbid2);

		JFormattedTextField sbid3 = new JFormattedTextField();
		sbid3.setFont(new Font("Tahoma", Font.PLAIN, 14));
		sbid3.setEditable(false);
		sbid3.setBounds(154, 275, 125, 25);
		contentPane.add(sbid3);

		JFormattedTextField sbid4 = new JFormattedTextField();
		sbid4.setFont(new Font("Tahoma", Font.PLAIN, 14));
		sbid4.setEditable(false);
		sbid4.setBounds(154, 310, 125, 25);
		contentPane.add(sbid4);

		JFormattedTextField sbid5 = new JFormattedTextField();
		sbid5.setFont(new Font("Tahoma", Font.PLAIN, 14));
		sbid5.setEditable(false);
		sbid5.setBounds(154, 345, 125, 25);
		contentPane.add(sbid5);

		sbid1 = new JFormattedTextField();
		sbid1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		sbid1.setEditable(false);
		sbid1.setBounds(154, 205, 125, 25);
		contentPane.add(sbid1);
		...
		btnback.setIcon(new ImageIcon(alclasses.class.getResource("/Images/back.png")));
		...
		btnsave.setIcon(new ImageIcon(alclasses.class.getResource("/Images/save.png")));
		btnsave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					//add 1st raw
					String subQuery = "select subjectID from subject where name='" + sbid1.getText().toString() + "'";
					...
					//add 2nd raw
					 String subQuery2 = "select subjectID from subject where name='" + sbid2.getText().toString() + "'";
					...
					//end 2nd row
					 ...
					 subQuery = "select subjectID from subject where name='" + sbid3.getText().toString() + "'";
					...
					stmt17.execute();
					 ...
					 subQuery = "select subjectID from subject where name='" + sbid4.getText().toString() + "'";
					...
					stmt18.execute();
					 ...
					 subQuery = "select subjectID from subject where name='" + sbid5.getText().toString() + "'";
		...
		btnsave.setBounds(367, 512, 121, 50);
		contentPane.add(btnsave);

		JButton btnupdate = new JButton("CHANGE  TABLE  STRUCTURE");
		btnupdate.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnupdate.setIcon(new ImageIcon(alclasses.class.getResource("/Images/update.png")));
...
*/
		...
		btnupdate.setBounds(585, 512, 260, 50);
		...
		btnDetails.setBounds(934, 440, 121, 50);
		contentPane.add(btnDetails);
		
				JLabel label_1 = new JLabel("");
				label_1.setIcon(new ImageIcon(alclasses.class.getResource("/Images/bg.png")));
		...
		try {
			...
			String query2 = "select name from subject where subjectID='SB20'";

			rs = stmt.executeQuery(query2);
			while (rs.next()) {
				sbid1.setText(rs.getString("name"));
			}

			String query3 = "select name from subject where subjectID='SB30'";

			rs = stmt.executeQuery(query3);
			while (rs.next()) {
				sbid2.setText(rs.getString("name"));
			}

			String query4 = "select name from subject where subjectID='SB31'";

			rs = stmt.executeQuery(query4);
			while (rs.next()) {
				sbid3.setText(rs.getString("name"));
			}
			...
			while (rs.next()) {
				sbid4.setText(rs.getString("name"));
			}
			...
			while (rs.next()) {
				sbid5.setText(rs.getString("name"));
			}

			
			//////////////////////////////////
			
			String subject1 = sbid1.getText().toString();
			...
			String subject = sbid2.getText().toString();
			...
			String subject3 = sbid3.getText().toString();
			...
			String subject4 = sbid4.getText().toString();
			...
			String subject5 = sbid5.getText().toString();
			...
			/*String q1 = "select name from staff where staffID='S016'";

			rs = stmt.executeQuery(q1);
			while (rs.next()) {
				comboBox_1.addItem((rs.getString("name")));
			}
			String q2 = "select name from staff where staffID='S017'";
